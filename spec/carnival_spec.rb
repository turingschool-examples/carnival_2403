...
RSpec.describe Carnival do 
    ...
    it 'can tell the most profitable ride' do
        ...
        expect(carnival_A.most_profitable_ride).to eq(ride2)
    end

    it 'can return total revenue for all rides' do
        carnival_A = Carnival.new(14)
        ride1 = Ride.new({ name: 'Carousel', min_height: 24, admission_fee: 1, excitement: :gentle })
        ride2 = Ride.new({ name: 'Ferris Wheel', min_height: 36, admission_fee: 5, excitement: :gentle })
        ride3 = Ride.new({ name: 'Roller Coaster', min_height: 54, admission_fee: 2, excitement: :thrilling })
        ...
        expect(carnival_A.total_revenue).to eq(19)
    end

    it 'can return visitor count' do
        carnival_A = Carnival.new(14)
        ride1 = Ride.new({ name: 'Carousel', min_height: 24, admission_fee: 1, excitement: :gentle })
        ride2 = Ride.new({ name: 'Ferris Wheel', min_height: 36, admission_fee: 5, excitement: :gentle })
        ride3 = Ride.new({ name: 'Roller Coaster', min_height: 54, admission_fee: 2, excitement: :thrilling })
        ...
        expect(carnival_A.visitor_count).to eq(3)
    end
end